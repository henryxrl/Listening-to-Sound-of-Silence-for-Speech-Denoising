...
# For inference, use one GPU only! There's a bug in this code when using multiple GPUs for inference. Command like this:
# avspeech_extract_flow.py --skip_training --skip_validation --inference --model FlowNet2 --save_flow --inference_dataset \
# ImagesFromFolder --inference_dataset_root '/home/henry/Desktop/3bj-ba3P_cU/3bj-ba3P_cU_0000001_faces' \
# --inference_dataset_iext jpg --resume checkpoints/FlowNet2_checkpoint.pth.tar --save '/home/henry/Desktop/3bj-ba3P_cU/3bj-ba3P_cU_0000001_faces' \
# --number_gpus 1
...
if __name__ == '__main__':
    ...
    def inference(args, epoch, data_loader, model, offset=0):
        ...
        if args.save_flow or args.render_validation:
            ...
            if args.skip_validation and args.skip_training and args.total_epochs == 1:
        ...
        for batch_idx, (data, target) in enumerate(progress):
            ...
            if args.save_flow or args.render_validation:
                for i in range(args.inference_batch_size):
                    ...
                    flow_utils.writeFlow( join(flow_folder, '%07d.flo'%(batch_idx * args.inference_batch_size + i + 1)),  _pflow)
