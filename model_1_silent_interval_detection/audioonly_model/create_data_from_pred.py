...
from tools import *
from predict import EXPERIMENT_PREDICTION_OUTPUT_DIR, HENRIQUE_JSON
...
if __name__ == "__main__":
    ...
    if not args.unknown_clean_signal:
        ...
        create_data_from_prediction_newtarget_bceloss_no_voting(os.path.join(EXPERIMENT_PREDICTION_OUTPUT_DIR, os.path.basename(HENRIQUE_JSON).split('.json')[0], input_json),\
