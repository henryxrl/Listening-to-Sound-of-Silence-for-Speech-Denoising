...
from tools import *
from predict import EXPERIMENT_PREDICTION_OUTPUT_DIR, HENRIQUE_JSON, LANGUAGES_JSON, LOOKING_TO_LISTEN_JSON, CE_JSON, SOUND_OF_SILENCE_JSON
...
if __name__ == "__main__":
    ...
    if not args.unknown_clean_signal:
        ...
        create_data_from_prediction_newtarget_bceloss_no_voting(os.path.join(EXPERIMENT_PREDICTION_OUTPUT_DIR, os.path.basename(SOUND_OF_SILENCE_JSON).split('.json')[0], input_json),\
