...
# On server run: python3 -m tensorboard.main --logdir train_log --port 10088 --host 127.0.0.1
# On google cloud server run: tensorboard --logdir train_log --port 10088 --host 127.0.0.1
# Multiple experiments:
# 1. ln -s train_log/log joint_experiments/exp1_log
# 2. ln -s ...
# 3. tensorboard --logdir joint_experiments --port 10088 --host 127.0.0.1
